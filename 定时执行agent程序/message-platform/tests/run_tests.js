...
async function main() {
  ...
  // Since the retry semantics change (2026-09-04), a failed/partial report inside the
  // 19:00-21:00 window triggers a retry rather than ending the day.
  assert.strictEqual(deferred.action, "collect_and_report");
